<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-row>
            <el-button @click="release(scope.row)" type="text" size="small" :disabled="scope.row.publishFlag==0">发布</el-button>
          </el-row>
        </template>
      </el-table-column>
    </el-table>
    ...
    <tradeSetting @closeSetting="closeSetting" v-if="isSetting" :openRow="openRow" :model="openRow.categoryMode=='1'?1:2" @refresh="getDealRules"></tradeSetting>
...
<script>
  ...
  import { getDealRules,updateDealRule,publishDealRule,deleteDealRule } from '@/api/modelRoleApi/transactionRules.js'
  import {
    existsByCGuid
