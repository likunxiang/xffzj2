<template>
  <div class="pages">
    ...
    <intelligenceDetail v-if="isDetail" @close="closeDetail" @refresh="getWaitApproUserList" :row="openRow" :categoryName="row.categoryName"></intelligenceDetail>
  </div>
</template>

<script>
  import {
    getWaitApproUserList
  ...
  export default {
    ...
    methods: {
      ...
      async getWaitApproUserList() {
		this.loading = true
        await getWaitApproUserList({
