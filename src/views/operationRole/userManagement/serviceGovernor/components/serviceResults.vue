      ...
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        ...
        <el-tab-pane label="采购验收通过订单数量" name="second">
          ...
          <el-table :data="tableData" border v-loading="loading">
            ...
            <el-table-column prop="phonenumber" label="岗位名称" align="center"></el-table-column>
            <el-table-column prop="createTime" label="创建日期" align="center"></el-table-column>
            <el-table-column prop="registerTime" label="采购订单验收通过数量" align="center"></el-table-column>
          </el-table>
        </el-tab-pane>
        <el-tab-pane label="供应验收通过订单数量" name="third">
          ...
          <el-table :data="tableData" border v-loading="loading">
            ...
            <el-table-column prop="phonenumber" label="岗位名称" align="center"></el-table-column>
            <el-table-column prop="createTime" label="创建日期" align="center"></el-table-column>
            <el-table-column prop="registerTime" label="供应订单验收通过数量" align="center"></el-table-column>
          </el-table>
        </el-tab-pane>
      </el-tabs>
