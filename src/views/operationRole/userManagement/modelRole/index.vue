<template>
  <div class="app-container">
    ...
    <passwordSetting v-if="isPasswordSet" @close="closePasswordSetting" @upData="getRoleList" :roleMsg="settingObj">
    </passwordSetting>
    <switchSetting v-if="isSwitch" @close="closeSwitchSetting" @upData="getRoleList" :roleMsg="settingObj">
    </switchSetting>
  </div>
</template>
