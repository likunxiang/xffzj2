<template>
  <el-dialog title="服务专员成果" :visible.sync="isOpen" width="700px" @close="beforeClose">
      ...
      <el-table :data="tableData" border v-loading="loading">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="text" @click="toResult(scope.row)">引导专员引导成果</el-button>
          </template>
        </el-table-column>
      </el-table>
      <pages @changePage="changePage" :total="pageTotal" :page="page"></pages>
      <guideResult v-if="isResult" @close="closeResult"></guideResult>
    </div>
  </el-dialog>
</template>
