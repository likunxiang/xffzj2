  ...
  <el-dialog title="查看月采购验收通过订单数量详情" :visible.sync="isOpen" width="700px" @close="beforeClose" :append-to-body="true">
    <div style="padding-bottom: 60px;">
      <el-descriptions :colon="false" class="margin-top" :column="1" :border="true" style="margin-bottom: 20px;">
        ...
        <el-descriptions-item label-class-name="my-label" content-class-name="my-content" label="供应验收通过订单数量">{{row.supplyNumber}}
        </el-descriptions-item>
      </el-descriptions>
    ...
    <checkOrderBySupply v-if="isRegister" @close="closeRegisterDetail" :row="openRow"></checkOrderBySupply>
  </el-dialog>
</template>
