  ...
  <el-dialog title="查看日采购验收通过订单数量详情" :visible.sync="isOpen" width="700px" @close="beforeClose" :append-to-body="true">
    <div style="padding-bottom: 60px;">
      ...
      <el-table :data="tableData" border v-loading="loading">
        ...
        <el-table-column prop="phonenumber" label="采购验收通过订单数量" align="center"></el-table-column>
    ...
    <serviceAttDetail v-if="isDetail" @close="closeAttDetail" :row="openRow" pageStatus="2"></serviceAttDetail>
  </el-dialog>
</template>
